...
/*   Updated: 2024/04/14 23:30:22 by astein           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	_grade(grade)
{
	...
	if (grade < 1)
		throw Bureaucrat::GradeTooHighException("Cannot create a Bureaucrat with a grade lower than 1!");
	else if (grade > 150)
		throw Bureaucrat::GradeTooLowException("Cannot create a Bureaucrat with a grade higher than 150!");
}
	...
	throw(Bureaucrat::GradeTooHighException)
{
	...
	if (_grade > 1)
		...
		throw Bureaucrat::GradeTooHighException("Cannot increment bureaucrats grade, it is already at the highest level aka 1!");
	return *this;
}
